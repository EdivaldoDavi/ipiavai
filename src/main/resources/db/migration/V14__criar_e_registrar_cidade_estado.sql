CREATE TABLE estado 
(
	codigo bigint  NOT NULL  DEFAULT nextval(('estado_id_seq'::text)::regclass),
	nome character varying(50),
	 
 CONSTRAINT codigo_estado_pkey PRIMARY KEY  (codigo) 
)
WITH (
  OIDS=FALSE
);
...
CREATE TABLE cidade
(
	    codigo bigint  NOT NULL  DEFAULT nextval(('cidade_id_seq'::text)::regclass),
		nome character varying(50) NOT NULL,
		codigo_estado bigint NOT NULL,
		CONSTRAINT codigo_cidade_pkey PRIMARY KEY  (codigo),
 
 	  CONSTRAINT fkestado FOREIGN KEY (codigo_estado)
