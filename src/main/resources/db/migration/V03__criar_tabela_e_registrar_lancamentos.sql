...
(
	codigo bigint NOT NULL DEFAULT nextval(('lancamentos_id_seq'::text)::regclass),
	...
	CONSTRAINT codigo_lancamento_pkey PRIMARY KEY  (codigo),
	
	 CONSTRAINT fkpessoa FOREIGN KEY (codigo_pessoa)
      REFERENCES pessoa (id_pessoa) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
 	 CONSTRAINT fkcategoria FOREIGN KEY (codigo_categoria)
      REFERENCES categoria (codigo) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
  OIDS=FALSE
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Top Club', '2017-03-10', '2017-03-10', 400.32, null, 'DESPESA', 4, 7);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Despachante', '2017-06-10', null, 123.64, 'Multas', 'DESPESA', 3, 5);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Pneus', '2017-04-10', '2017-04-10', 665.33, null, 'RECEITA', 5, 4);
