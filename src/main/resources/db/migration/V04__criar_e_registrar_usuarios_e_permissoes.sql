...
INSERT INTO permissao (codigo, descricao, apelido_descricao) values (1, 'ROLE_CADASTRAR_CATEGORIA', 'Cadastrar Categoria');
INSERT INTO permissao (codigo, descricao, apelido_descricao) values (2, 'ROLE_PESQUISAR_CATEGORIA', 'Pesquisar Categoria');

INSERT INTO permissao (codigo, descricao, apelido_descricao) values (3, 'ROLE_CADASTRAR_PESSOA', 'Cadastrar Pessoa');
INSERT INTO permissao (codigo, descricao, apelido_descricao) values (4, 'ROLE_REMOVER_PESSOA', 'Excluir Pessoa');
INSERT INTO permissao (codigo, descricao, apelido_descricao) values (5, 'ROLE_PESQUISAR_PESSOA', 'Pesquisar Pessoa');

INSERT INTO permissao (codigo, descricao, apelido_descricao) values (6, 'ROLE_CADASTRAR_LANCAMENTO', 'Cadastrar Lançamento');
INSERT INTO permissao (codigo, descricao, apelido_descricao) values (7, 'ROLE_REMOVER_LANCAMENTO', 'Excluir Lançamento');
INSERT INTO permissao (codigo, descricao, apelido_descricao) values (8, 'ROLE_PESQUISAR_LANCAMENTO', 'Pesquisar Lançamento');
