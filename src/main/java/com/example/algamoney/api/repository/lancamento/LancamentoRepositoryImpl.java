...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	@Override
	public List<LancamentoEstatisticaCategoria> despesasReceitas(LocalDate inicio, LocalDate fim) {
		CriteriaBuilder criteriaBuilder = manager.getCriteriaBuilder();
		...
		criteriaQuery.groupBy(root.get(Lancamento_.categoria), root.get(Lancamento_.tipo));
		criteriaQuery.orderBy(criteriaBuilder.desc(root.get(Lancamento_.tipo)), criteriaBuilder.desc(root.get(Lancamento_.categoria)));
